...
Preliminary turbomachinery design runs on a handful of excellent proprietary suites, quote-only pricing where the few public data points run well into five figures per seat-year, none of them web-native, none of them open. Cascade is the open alternative: free to self-host, forever.
