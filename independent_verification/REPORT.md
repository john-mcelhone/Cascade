...
| Mean-line: radial inflow turbine | 13 | 0 | 0 |
| Optimization (SLSQP / CMA-ES / NSGA-II) | 9 | 0 | 0 |
| Rotor dynamics (beam-FEM) | 10 | 0 | 0 |
| Slip-factor correlations | 26 | 0 | 0 |
| Design-space sampling (Sobol') | 6 | 0 | 0 |
| Units engine | 10 | 0 | 0 |

All implemented-subsystem checks are within their known physical and published bounds. No action required.
